...
public class SendMoney {
    ...
    public void sending() {
        ...
        long amt, balance=1000,send;
        System.out.println("Enter the sending money which you want: ");
        send = sc.nextLong();

        if (balance >= send) {
            balance = balance - send;
            System.out.println("Balance after sending money: " + balance);
        } else {
            System.out.println("Your balance is less than " + send + "\tTransaction failed...!!" );
        }
    }
